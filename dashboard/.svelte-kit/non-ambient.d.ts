...
declare module "$app/types" {
	...
	export interface AppTypes {
		RouteId(): "/" | "/api" | "/api/architecture" | "/api/context" | "/api/files" | "/api/state" | "/architecture" | "/browse";
		RouteParams(): {
		...
		Pathname(): "/" | "/api/architecture" | "/api/context" | "/api/files" | "/api/state" | "/architecture" | "/browse";
